...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/email-verification/email-verification.component.html":
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/email-verification/email-verification.component.html ***!
  \*******************************************************************************************************************/
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/otp-password-verification/otp-password-verification.component.html":
/*!*********************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/otp-password-verification/otp-password-verification.component.html ***!
  \*********************************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/otp-verification/otp-verification.component.html":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/otp-verification/otp-verification.component.html ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/payment-details/payment-details.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/payment-details/payment-details.component.html ***!
  \*************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/signup/signup.component.html":
/*!*******************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/signup/signup.component.html ***!
  \*******************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/thank-you/thank-you.component.html":
/*!*************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/thank-you/thank-you.component.html ***!
  \*************************************************************************************************/
/*! exports provided: default */
...
/***/ "./src/app/shared/email-verification/email-verification.component.css":
/*!****************************************************************************!*\
  !*** ./src/app/shared/email-verification/email-verification.component.css ***!
  \****************************************************************************/
/*! exports provided: default */
...
let EmailVerificationComponent = class EmailVerificationComponent {
    constructor(formBuilder, toastr, utils, api, router) {
    ...
    onSubmit() {
        ...
        this.api.forgotPassword(data).subscribe(data => {
            ...
            this.router.navigate(['/otp-password-verification']);
        }, error => {
...
EmailVerificationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./email-verification.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/email-verification/email-verification.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./email-verification.component.css */ "./src/app/shared/email-verification/email-verification.component.css")).default]
    })
...
let ForgotPasswordComponent = class ForgotPasswordComponent {
    ...
    onSubmit() {
        ...
        console.log(data);
        this.api.resetPassword(data).subscribe(data => {
            console.log('success', data);
            console.log(data["response"]);
            console.log(":::::::::::::::::");
            this.toastr.success(data["message"]);
...
let LoginComponent = class LoginComponent {
    ...
    onSubmit() {
        ...
        this.api.login(this.loginForm.value).subscribe(data => {
            ...
            this.utils.set('marketplace_seller', data['response']);
            this.utils.alert('', 'seller logged in successfully');
...
/***/ "./src/app/shared/otp-password-verification/otp-password-verification.component.css":
/*!******************************************************************************************!*\
  !*** ./src/app/shared/otp-password-verification/otp-password-verification.component.css ***!
  \******************************************************************************************/
/*! exports provided: default */
...
/*!*****************************************************************************************!*\
  !*** ./src/app/shared/otp-password-verification/otp-password-verification.component.ts ***!
  \*****************************************************************************************/
/*! exports provided: OtpPasswordVerificationComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OtpPasswordVerificationComponent", function() { return OtpPasswordVerificationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js");
...
let OtpPasswordVerificationComponent = class OtpPasswordVerificationComponent {
    ...
    verifyOtp() {
        ...
        this.auth.verifyPasswordOtp(data).subscribe(res => {
    ...
    resendOtp() {
        this.auth.resendOtp().subscribe(res => {
    ...
    sendEmailVerification() {
        this.auth.sendEmailVerification().subscribe(res => {
            console.log(res["message"]);
            this.toastr.success(res["message"]);
        }, error => {
            console.log(error);
...
OtpPasswordVerificationComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _service_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"] },
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
OtpPasswordVerificationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-otp-password-verification',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./otp-password-verification.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/otp-password-verification/otp-password-verification.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./otp-password-verification.component.css */ "./src/app/shared/otp-password-verification/otp-password-verification.component.css")).default]
    })
...
/***/ "./src/app/shared/otp-verification/otp-verification.component.css":
/*!************************************************************************!*\
  !*** ./src/app/shared/otp-verification/otp-verification.component.css ***!
  \************************************************************************/
/*! exports provided: default */
...
OtpVerificationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./otp-verification.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/otp-verification/otp-verification.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./otp-verification.component.css */ "./src/app/shared/otp-verification/otp-verification.component.css")).default]
    })
...
/***/ "./src/app/shared/payment-details/payment-details.component.css":
/*!**********************************************************************!*\
  !*** ./src/app/shared/payment-details/payment-details.component.css ***!
  \**********************************************************************/
/*! exports provided: default */
...
PaymentDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./payment-details.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/payment-details/payment-details.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./payment-details.component.css */ "./src/app/shared/payment-details/payment-details.component.css")).default]
    })
...
let RegisterComponent = class RegisterComponent {
    ...
    // convenience getter for easy access to form fields
    get f() { return this.profileDetailsForm.controls; }
    onCountryChange(event) {
    ...
    fetchSellerDetails() {
        ...
        var data = { "_id": userId };
        if (userId) {
            this.api.fetchSellerDetails(data).subscribe(res => {
                // console.log(res['response'])
                this.sellerData = res['response'];
            }, err => {
                console.log(err);
            });
        }
    ...
    upload_store_trading_license(event) {
        ...
        this.api.uploadFile(uploadData).subscribe((res) => {
            ...
            this.storeTradingLicense.push(res.response.imageUrl);
        });
    }
    upload_store_signatory_id(event) {
        let uploadData = new FormData();
        ...
        this.api.uploadFile(uploadData).subscribe((res) => {
            console.log(res.response.imageUrl);
            this.storeSignatoryId.push(res.response.imageUrl);
        });
    }
    upload_store_vat_certificate(event) {
        let uploadData = new FormData();
        ...
        this.api.uploadFile(uploadData).subscribe((res) => {
            console.log(res.response.imageUrl);
            this.storeVatCertificate.push(res.response.imageUrl);
        });
    }
    upload_iban_certificate(event) {
        let uploadData = new FormData();
        ...
        this.api.uploadFile(uploadData).subscribe((res) => {
            console.log(res.response.imageUrl);
            this.ibanCertificate.push(res.response.imageUrl);
        });
    }
    onPlanChange(value) {
    ...
    onSubmit() {
        ...
        // debugger
        this.api.addBankDetails(profileData).subscribe(data => {
            console.log('success', data);
            console.log(data["response"]);
            console.log(":::::::::::::::::");
            // $('#success-modal').modal('show')
            this.toastr.success("Thank you for Registration");
    ...
    getCountryList() {
        this.api.get_all_country().subscribe(res => {
            this.country_list = res['response'];
        }, err => {
            console.log(err);
        });
    }
    ...
    getCityByCountry(countryCode) {
        ...
        this.api.get_city_of_country(data).subscribe(res => {
            this.city_list = res['response'];
        }, err => {
            console.log(err);
        });
    }
...
/* harmony import */ var _signup_signup_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./signup/signup.component */ "./src/app/shared/signup/signup.component.ts");
/* harmony import */ var _otp_verification_otp_verification_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./otp-verification/otp-verification.component */ "./src/app/shared/otp-verification/otp-verification.component.ts");
/* harmony import */ var _payment_details_payment_details_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./payment-details/payment-details.component */ "./src/app/shared/payment-details/payment-details.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./register/register.component */ "./src/app/shared/register/register.component.ts");
/* harmony import */ var _email_verification_email_verification_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./email-verification/email-verification.component */ "./src/app/shared/email-verification/email-verification.component.ts");
/* harmony import */ var _otp_password_verification_otp_password_verification_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./otp-password-verification/otp-password-verification.component */ "./src/app/shared/otp-password-verification/otp-password-verification.component.ts");
/* harmony import */ var _thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./thank-you/thank-you.component */ "./src/app/shared/thank-you/thank-you.component.ts");
...
const routes = [
    ...
    { path: 'otp-verification', component: _otp_verification_otp_verification_component__WEBPACK_IMPORTED_MODULE_6__["OtpVerificationComponent"] },
    { path: 'payment-details', component: _payment_details_payment_details_component__WEBPACK_IMPORTED_MODULE_7__["PaymentDetailsComponent"] },
    ...
    { path: 'otp-password-verification', component: _otp_password_verification_otp_password_verification_component__WEBPACK_IMPORTED_MODULE_10__["OtpPasswordVerificationComponent"] },
    { path: 'thank-you', component: _thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_11__["ThankYouComponent"] },
];
...
/* harmony import */ var ng2_tel_input__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ng2-tel-input */ "./node_modules/ng2-tel-input/esm2015/ng2-tel-input.js");
/* harmony import */ var _shared_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared-routing.module */ "./src/app/shared/shared-routing.module.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./login/login.component */ "./src/app/shared/login/login.component.ts");
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ "./src/app/shared/forgot-password/forgot-password.component.ts");
/* harmony import */ var _signup_signup_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./signup/signup.component */ "./src/app/shared/signup/signup.component.ts");
...
/* harmony import */ var _common_comman_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../common/comman.module */ "./src/app/common/comman.module.ts");
/* harmony import */ var _otp_verification_otp_verification_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./otp-verification/otp-verification.component */ "./src/app/shared/otp-verification/otp-verification.component.ts");
/* harmony import */ var _payment_details_payment_details_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./payment-details/payment-details.component */ "./src/app/shared/payment-details/payment-details.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./register/register.component */ "./src/app/shared/register/register.component.ts");
/* harmony import */ var _email_verification_email_verification_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./email-verification/email-verification.component */ "./src/app/shared/email-verification/email-verification.component.ts");
/* harmony import */ var _otp_password_verification_otp_password_verification_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./otp-password-verification/otp-password-verification.component */ "./src/app/shared/otp-password-verification/otp-password-verification.component.ts");
/* harmony import */ var _thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./thank-you/thank-you.component */ "./src/app/shared/thank-you/thank-you.component.ts");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _payment_details_payment_details_component__WEBPACK_IMPORTED_MODULE_16__["PaymentDetailsComponent"],
            _register_register_component__WEBPACK_IMPORTED_MODULE_17__["RegisterComponent"],
            _email_verification_email_verification_component__WEBPACK_IMPORTED_MODULE_18__["EmailVerificationComponent"],
            _otp_password_verification_otp_password_verification_component__WEBPACK_IMPORTED_MODULE_19__["OtpPasswordVerificationComponent"],
            _thank_you_thank_you_component__WEBPACK_IMPORTED_MODULE_20__["ThankYouComponent"],
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _shared_routing_module__WEBPACK_IMPORTED_MODULE_8__["SharedRoutingModule"],
            ...
            _common_comman_module__WEBPACK_IMPORTED_MODULE_14__["CommanModule"]
        ]
    })
], SharedModule);
...
/***/ "./src/app/shared/signup/signup.component.css":
/*!****************************************************!*\
  !*** ./src/app/shared/signup/signup.component.css ***!
  \****************************************************/
/*! exports provided: default */
...
SignupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-signup',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./signup.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/signup/signup.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./signup.component.css */ "./src/app/shared/signup/signup.component.css")).default]
    })
], SignupComponent);
...
/***/ "./src/app/shared/thank-you/thank-you.component.css":
/*!**********************************************************!*\
  !*** ./src/app/shared/thank-you/thank-you.component.css ***!
  \**********************************************************/
/*! exports provided: default */
...
ThankYouComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./thank-you.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/thank-you/thank-you.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./thank-you.component.css */ "./src/app/shared/thank-you/thank-you.component.css")).default]
    })
], ThankYouComponent);
